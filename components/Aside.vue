<template>
  <div class="border-r h-screen max-w-xs relative w-full">
    ...
    <section class="absolute border-t flex px-8 py-4 pin-b pin-x">
      <button class="bg-grey-light border border-grey-light block text-black font-bold rounded px-4 py-3 w-full focus:outline-none focus:border-green hover:bg-grey hover:border-grey">Get Code</button>
    </section>
  </div>
</template>
